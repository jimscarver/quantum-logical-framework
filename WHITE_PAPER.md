...
The framework is formally verified in **Lean 4 across 107 modules with zero `sorry` blocks**, its
...
- **107 Lean 4 modules, zero `sorry` blocks**; the combinatorial core within RCA₀. The full module
