...
**Net:** #118's residue is now **{(a1) proper involution + (a2) the projection-lattice bridge} + (b) the Gleason-hard uniqueness** — proven on the Boolean core, reduced to named facts on the rendering. **Honest scope:** a *further narrowing*, not a derivation — a full Lean proof of the non-distributive orthomodular law needs orthomodular-lattice machinery + the Baer-`*`-ring theorem that are not in Mathlib.
