...
- [**Weak_Force.md**](Weak_Force.md) — the weak sector consolidated: W/Z as gauge-fold closures, the machine-verified weak-isospin SU(2)⊂Σ₈ identification, beta decay, and the τ-decay-vertex blocker (with an honest derived/sketched/open split)
