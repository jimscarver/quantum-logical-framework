...
- [**Beyond_Standard_Model.md**](Beyond_Standard_Model.md) — honest accounting of where QLF goes past the SM: which free parameters it *forces* (machine-verified), the one falsifiable new prediction (Dirac neutrino / no 0νββ), and what it leaves open — with a bright forced/predicted/open line
