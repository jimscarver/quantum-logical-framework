...
| **N = 9 directional-mode tensor** appears in the emergent E-conservation renormalisation `(1+9α)⁻¹` | §6.3 + Magnetism_Spatial_Dynamics.md §6.1.1. Three QLF-natural readings: 3² spatial directional-coupling tensor, 8+1 twist generators + identity, 3 + \|S_3\| chirality permutations | If a refined substrate count requires N ≠ 9 to match CODATA, the 3² directional-tensor reading would need revision; QED is unaffected |
