...
### Lean-verified theorems (77 active modules, zero `sorry`)
...
*This list is illustrative; the authoritative, always-current table of all 77 modules and their key theorems is [`lean/README.md`](lean/README.md).*
