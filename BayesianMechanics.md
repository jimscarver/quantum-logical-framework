# Bayesian Mechanics in the Quantum Logical Framework
...
See also: [AI.md](AI.md); [Measurement_Problem.md](Measurement_Problem.md) — ZFA closure as the physical realization of Bayesian update / measurement; [Hierarchical_Control.md](Hierarchical_Control.md) — multiplicity principle as bottom-up driver, Markov-blanket-screened prior as top-down constraint; derives Friston's free energy principle from ZFA; [Born_Rule.md](Born_Rule.md) — the multiplicity principle plus the uniform prior over admissible histories derives the Born rule rather than postulating it; [Active_Inference_Mathematics.md](Active_Inference_Mathematics.md) — folds the multiplicity-as-probability reading into the active-inference math framing where admissible trajectories are the mathematical objects.
