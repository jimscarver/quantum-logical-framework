...
**Topological angle**. The 720° double cover of SO(3) by SU(2) ([Hierarchical_Control.md §2](Hierarchical_Control.md) and HALF-SPIN-ZFA-EMBEDDING.md) gives fermions a non-trivial $-1$ phase under $2\pi$ rotation. Exchange of two identical fermions is geometrically a $\pi$ rotation of one around the other in the worldline picture (Feynman–Wheeler); odd half-turn = $-1$ phase = antisymmetric exchange. Bosons (even half-turn count) pick up no phase = symmetric exchange.
