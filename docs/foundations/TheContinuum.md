...
See also: [ReverseMathematics.md](ReverseMathematics.md) for the formal subsystem analysis, [SpaceTime.md](../physics/SpaceTime.md) for the event-synthesis picture, and [Philosophy.md](Philosophy.md) for the possibilist ontological grounding.
