...
See: [`StringTheory.md`](../physics/StringTheory.md).

---

## 6. Experimental Consistency

See the dedicated document [`Experimental_Consistency.md`](../physics/Experimental_Consistency.md) for detailed mappings to current and near-future experiments (DESI, Euclid, LHC upgrades, quantum-gravity tabletop tests).
...
python -m qlf.spacetime_dynamics          # completed Einstein + accelerated expansion
...
- [`UniversalRelativity.md`](../physics/UniversalRelativity.md)  
- [`Philosophy.md`](Philosophy.md)  
- [`StringTheory.md`](../physics/StringTheory.md)  
- [`Experimental_Consistency.md`](../physics/Experimental_Consistency.md)  
