...
In QLF's possibilist ontology, **ℒ = 0 is not a filter applied to a pre-existing universe — it is the condition of origin itself.** The universe IS what achieves Zero Free Action. Histories without ZFA closure are not eliminated from existence; they never had it. See [Philosophy.md](../foundations/Philosophy.md) for the full possibilist foundation and [TheBigProblem.md](../foundations/TheBigProblem.md) for how this resolves the measurement problem, spacetime, and gravity without additional postulates.
...
**Discrete primary form.** In QLF, the fundamental formulation is discrete. The 8-twist alphabet `{^, v, <, >, /, \, +, −}` (see [QuCalc.md](QuCalc.md) and [eight-twists-sufficiency.md](../physics/eight-twists-sufficiency.md)) generates event histories whose imbalance is tracked component-wise by `computeImbalance` ([ZFAEventDynamics.lean:90](../../lean/ZFAEventDynamics.lean)). ZFA closure requires all 8 counts to vanish simultaneously:
...
**Continuous limit.** The continuous Lagrangian emerges through `EventSynthesisField`, which carries a scalar field φ, its time derivative, and potential V_φ. These map to the stress-energy tensor and effective cosmological constant `Λ_eff` ([SpacetimeDynamics.lean:57](../../lean/SpacetimeDynamics.lean)), recovering Einstein-like field equations in the continuum limit. See [SpaceTime.md](../physics/SpaceTime.md) for the event-synthesis picture and [Gravity.md](../physics/Gravity.md) for emergent gravity from ZFA event rate and gauge-fold depth.
...
Any decohering interaction would require violating either the zero-action condition or the algebraic structure. Since both are enforced by construction and machine-verified, decoherence is a logical contradiction rather than environmental noise. See [Measurement_Problem.md](../physics/Measurement_Problem.md) for the full treatment of measurement as ZFA closure, and [ER_EPR_QLF.md](../physics/ER_EPR_QLF.md) for the entanglement-geometry connection.
...
|---|---|---|
| ZFA imbalance closure | [lean/ZFAEventDynamics.lean](../../lean/ZFAEventDynamics.lean) | [SpaceTime.md](../physics/SpaceTime.md), [Gravity.md](../physics/Gravity.md) |
...
| 8-twist alphabet | [lean/QLF_Axioms.lean](../../lean/QLF_Axioms.lean) | [QuCalc.md](QuCalc.md), [eight-twists-sufficiency.md](../physics/eight-twists-sufficiency.md) |
...
| String mode degeneracy | [lean/StringTheoryQLF.lean](../../lean/StringTheoryQLF.lean) | [StringTheory.md](../physics/StringTheory.md) |
| Church-Turing universality | [lean/QLF_Universality.lean](../../lean/QLF_Universality.lean) | [Universality.md](../foundations/Universality.md), [ReverseMathematics.md](../foundations/ReverseMathematics.md) |
| Measurement / decoherence | [lean/BraKetRhoQuCalc.lean](../../lean/BraKetRhoQuCalc.lean) (`decoherence_impossibility`, `commutator_zero_diagonal`) | [Measurement_Problem.md](../physics/Measurement_Problem.md), [TheBigProblem.md](../foundations/TheBigProblem.md) |
| Entanglement / ER=EPR | [lean/ER_EPR_QLF.lean](../../lean/ER_EPR_QLF.lean) | [ER_EPR_QLF.md](../physics/ER_EPR_QLF.md) |
| Possibilist origin / ZFA | — | [Philosophy.md](../foundations/Philosophy.md), [TheContinuum.md](../foundations/TheContinuum.md) |
| QPU / security / OS | — | [QuantumOS.md](../computing/QuantumOS.md) |
