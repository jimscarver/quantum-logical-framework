...
- Companion document: [INFEASIBILITY-OF-FULL-UNIVERSE-SIMULATION.md](../physics/Simulation_Impossibility.md)
- [Measurement_Problem.md](../physics/Measurement_Problem.md) — the half-spin ZFA embedding IS the foundational resolution: ZFA closure at causal intersection dissolves collapse without extra postulates
