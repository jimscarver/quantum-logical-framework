...
- [HALF-SPIN-ZFA-EMBEDDING.md](../formal/HALF-SPIN-ZFA-EMBEDDING.md) — origin of the ( hbar / 2 ) unit
- [Hermitian_Conjugacy_Proof.md](../formal/Hermitian_Conjugacy_Proof.md) — non-commutativity of conjugate twists
