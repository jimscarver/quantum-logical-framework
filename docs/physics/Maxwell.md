...
See [Experimental_Consistency.md](Experimental_Consistency.md) for the full derivation with force law and energy accounting. See [maxwell_qlf.py](../../experiments/maxwell_qlf.py) for numerical confirmation.
...
This places electromagnetism within the same derivational chain as gravity ([Gravity.md](Gravity.md)), spacetime synthesis ([SpaceTime.md](SpaceTime.md)), and the Riemann symmetry condition ([Riemann-Conjecture-Proof.md](../formal/Riemann-Conjecture-Proof.md)) — all consequences of ZFA, none postulated separately.

See [Lagrangian_Formulation.md](../formal/Lagrangian_Formulation.md) for the variational form (ℒ = 0) that unifies all of these.
