...
- [`QLF_Knot_Theory_Nature_2025.md`](../research-notes/QLF_Knot_Theory_Nature_2025.md) — experimental knot-theory evidence (Nature 2025) linking topological string structures to QLF's twist algebra.
