...
```bash
$ python -m experiments.atomic_routing --core_state "Proton_Cluster" --inject_electrons 2 --verbose True
```
...
```bash
$ python -m experiments.atomic_routing --inject_electrons 3
...
```bash
$ python -m experiments.atomic_routing --inject_electrons 10
