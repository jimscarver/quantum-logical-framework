...
See also: [Universality.md](../foundations/Universality.md) — the complementary result: while the full universe cannot be simulated, QLF IS universal for all terminating computations; the two results together bound what is and isn't computable about physical reality.
