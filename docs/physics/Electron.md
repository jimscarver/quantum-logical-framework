...
```bash
python -m qlf.particles --seed "^<" --max-depth 4 --enable-gauge True
```
...
python -m qlf.particles --seed "^>" --max-depth 2 --enable-gauge False

# Antiphoton conjugate
python -m qlf.particles --seed "v<" --max-depth 2 --enable-gauge False
```
...
```bash
python -m qlf.particles --seed "^<" --max-depth 6 --enable-gauge True --environment-block
```
...
|--------------------------------|-------------------------------------------------------------------------|----------------------------------|
| Electron (massive, gauge-folded) | `python -m qlf.particles --seed "^<" --max-depth 4 --enable-gauge True`   | Gauge fold → mass + local time   |
| Photon (massless)              | `python -m qlf.particles --seed "^>" --max-depth 2 --enable-gauge False`   | Pure forward-time spatial fold   |
| Photon + antiphoton ZFA        | Run both seeds above                                                    | Net action = 0 (annihilation)    |
| Electron–proton scattering     | `python -m qlf.particles --seed "^<" --max-depth 6 --enable-gauge True`    | Gauge handshake + photon emission|
