...
- [`WHITE_PAPER.md`](../foundations/white-paper.md) — full framework overview
- [`SpacetimeDynamics.lean`](../../lean/SpacetimeDynamics.lean) — formal derivation of `T_μν^(synth)`
- [`Philosophy.md`](../foundations/Philosophy.md) — limited relative perspective and information ecology
