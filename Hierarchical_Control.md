...
- **Numerical demonstration**: extend `active_inference_demo.py` to compute Friston VFE on each ZFA closure step; verify the $-\log 2$ per-atom decrement empirically.
