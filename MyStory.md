...
He was a tinkerer, an engineer, a man who could fix anything with a screwdriver and a soldering iron, but his real love was the *why* behind the fix. His extensive knowledge reached to the very fringes of bleeding edge science.

I still remember him explaining simplified relativity to me, including his own “Whitescarver flying saucer” invention based on mass increase due to gravity. He wrote letters to scientists, including Einstein, but received no replies until I was a teenager. To me the flying saucer was proven, so I was saddened when my father sat me down to explain why it wouldn’t actually work. That was a true Aha! moment. It taught me that what they teach about relativity is often wrong. People still think the relativistic effects we *see* are “real,” but locally nothing changes. Mass change due to motion or gravity is a useful illusion; locally nothing changes, it's just a mathematical trick. Motion is only relative — even falling into a black hole ([BLACK-HOLES.md](BLACK-HOLES.md)). Later my father cautioned me: “Read Einstein, don’t read *about* Einstein.” It seemed every popular account of Einstein was misleading at best. They say he proved there is no aether. Whereas he said a universe without aether was unthinkable. I felt like I had a personal relationship with Einstein and even had dialogs with him in my dreams. They say he didn’t understand quantum physics. He insisted it could not be non-local or random. His record proves he understood quantum physics better than anyone. In the end, my quantum logical deterministic constructive model vindicates him. His only mistake was to consider anything besides quantum entanglement to be real. The quantum creation operator creates nothing else. This led him to not realize the simple fact that because light speed events are dilated to zero time and zero space, they are same time same place local events. It seemed to me he apologized for that. Light speed entanglements simply delay locality relatively such that the past determines the future. Only information arriving locally from the past can cause anything locally. The past causing the future is purely local. Einstein is vindicated ([UniversalRelativity.md](UniversalRelativity.md)).

Dad taught me that the only thing happening in this world are quantum mechanical events — electron interactions that keep us from falling through our chair, heat, light, radio and everything bouncing off everything. He taught me that everything is equal and opposite action. I learned later that this requires Zero Free Action (ZFA) ([zfa-catalog-rho-notation.md](zfa-catalog-rho-notation.md)). The universe can’t get free action from anywhere. ZFA is the only rule.
...
After high school I headed to **Widener College** (now Widener University). I majored in electrical engineering because I already “knew everything about computer science” (ha!). I had fun with analog computers that solved differential equations almost magically. One professor proved to us that the most data you could send over a phone line was 300 bits per second. I protested that you could hear a symphony over a phone which was thousands of bits. He thought I just didn’t get it.

College seemed a waste of time — they were only teaching half-truths — so in 1968 I quit school and joined the hippie revolution. I hitched to California, lived in igloos and under bridges, and trekked the mountains around Aspen, Colorado. I did drugs and experienced the cosmic consciousness of the information universe. I realized that there was an independent quantum system at every distinct frequency and since any analog signal can be expressed exactly in discrete bits I concluded that the wave we saw was just the composite of quantum systems at each frequency. The quantum was not small, it is the only thing happening at every scale up to the size of the universe.

### Marriage and the Next Chapter

After a year I bicycled home through Wyoming and Nebraska, then hitched back and stopped at Widener, where I met the woman who would become my wife. We eventually had five children. When I got home my mother demanded that I stay, so I went back to work as a programmer for the family business.

Eventually I grew tired of writing the same payroll, accounts payable, general ledger, etc. that thousands of other programmers were writing. Shouldn’t computers eliminate this redundancy? Maybe AI was the answer. I wrote an Eliza-like program that passed the Turing test trivially by including specific information about people in the office. In 1970 I decided to go back to school to learn real AI.

### NJIT, EIES, Murray Turoff & Roxanne Hiltz

Then came **NJIT** — New Jersey Institute of Technology. This time I majored in computer science and minored in electrical engineering. That was where things got electric in a whole new way.

I landed in the world of computer-mediated communication, working with the true pioneers: **Murray Turoff**, the visionary who developed the first chat system, and **Roxanne Hiltz**, a brilliant social scientist who taught me rigorous scientific analysis. Murray said to me, “You can spend your whole life building one computer as smart as a human, or you can build a system that enables the collective intelligence among humans.” That became my new mission.

We built **EIES** — the Electronic Information Exchange System — one of the very first online conferencing systems in the world. We were literally inventing how humans talk to each other through machines before the internet was even a household word. At the time the chairman of the computer science department remarked, “Nobody will ever waste the power of a computer doing electronic mail.” We were far ahead of our time. We became a sort of true internet, connecting Mailnet, Bitnet, Arpanet, and the commercial packet-switched networks, introducing the internet to business. We developed SGML markup to tailor the user interface years before the World Wide Web and introduced forms (making the web interactive) and objects (XML) to the wider community. Our research results have largely been forgotten and only corroborated this century — often without crediting our work.

I developed the idea of an interface language called Interact, allowing second-order user programming. Groups developed groupware for their particular communication needs on top of EIES using Interact. Thousands of commands were developed largely by the users themselves.
...
One of the highlights was my time at **AT&T Shannon Research Labs**. (Yes, *that* Shannon — information theory.) I worked on problems that lived right at the boundary between classical bits and something deeper. Out of that work came a patent for multifactor risk analysis and the first voice and video and device authentication system. 
...
On RChain With Dan Connoly we developed  ([Rgov](https://github.com/rchain-community/rgov)) a totally secure user programable group communication prototype with rank order voting, chat, multisig wallets and trust networking. Unfortunately, like the rest of the communities I participated in, rchain died.
...
The Quantum Logical Framework has now grown to **77 machine-verified Lean 4 modules with zero `sorry` blocks**, its combinatorial core living strictly within **RCA₀** — below the Axiom of Choice, below the Busy Beaver horizon. From the single ZFA postulate, with no fitting parameters, it now delivers (see full technical overview, executable code, and Lean4 proofs in the repository):
...
- **The Standard Model from counting.** The three fermion generations *are* the three spatial axes; the gauge groups fall out of the 8-twist algebra (weak SU(2), strong SU(3), Weinberg `sin²θ_W = 3/8`); and the entire mass hierarchy — the 10¹⁹ Planck/proton ratio — collapses to the single integer `b₀ = 7` as `e^{14π}` ([Standard_Model.md](Standard_Model.md), [Per_Qubit_Mass_Quantum.md](Per_Qubit_Mass_Quantum.md)).
- **Gravity and cosmology, derived not postulated.** Newton's law and `G = L_P²c³/ℏ` from holographic delay; Mercury's perihelion to 0.03%; the **Einstein field equations as the substrate's equation of state** (Jacobson), tied to Hitoshi Kitada's local time — every local horizon is a Markov-blanket clock and `Λ = Ω_Λ = log 2` is its tick ([Einstein_Equations.md](Einstein_Equations.md), [Kitada_Local_Time_GR.md](Kitada_Local_Time_GR.md)); the **curvature side from the causal order** (Sorkin / Benincasa–Dowker on the closure graph); Unruh/Hawking/de Sitter temperatures from one relation; **dark matter and dark energy** as one expand/contract duality on a single Hubble horizon; inflation without an inflaton ([Gravity.md](Gravity.md), [DarkMatter.md](DarkMatter.md)). The **age of the universe is not an empirical input** but a *count of Planck ticks* `t₀ = N·τ_Planck` — `ℏ` fixes the tick, the substrate fixes the count.
- **The grand unification — four forces as one closure.** Electromagnetism, the weak force, and the strong force are **one substrate gauge interaction**: EM the *abelian* gauge trace (the massless photon), weak and strong its *non-abelian* spatial projections seen at different logical densities, with electroweak symmetry breaking as a density threshold. And **gravity is the fourth force as the *geometry* of the same closures** — not a gauge force — joined to the gauge sector at *mass = constructing delay*, so the equivalence principle falls out of the substrate. Einstein made spacetime relative; QLF makes *everything* relative — the grand unification ([UniversalRelativity.md](UniversalRelativity.md) §4a, [Forces_From_Three_Axes.md](Forces_From_Three_Axes.md) §3a–3b).
- **Nuclear fusion and the weak force.** Fusion is two Markov blankets joining; two *identical* proton blankets are Pauli-insulated, so the weak β⁺ step is the precondition for the very first join — the "sex" of proton and neutron ([Fusion.md](Fusion.md), [SEX.md](SEX.md)). Muon-catalyzed fusion — the *legitimate* cold fusion — is reproduced in agreement with the Standard Model, with catalysis touching the rate but never the β⁺ necessity ([Fusion.md](Fusion.md) §3b).
- **The Millennium program.** All six Clay problems — Riemann, the Yang–Mills mass gap, Birch–Swinnerton-Dyer, Hodge, P vs NP, and Navier–Stokes — are each reduced to a constructive RCA₀ core plus **one** named boundary axiom marking the continuum/choice crossing, exactly where ZFC is *itself* proven to fail (Gödel, Turing, Busy Beaver). The continuum is mathematics' ultraviolet catastrophe; the discrete ZFA substrate is its resolution ([Continuum_Choice_Fallacy.md](Continuum_Choice_Fallacy.md), [Millennium.md](Millennium.md)).
- **Predicted physical constants emerge** from the single ZFA postulate with no fitting parameters: the fine-structure constant **α ≈ 1/137** from substrate combinatorics alone ([Alpha.md](Alpha.md), [Hydrogen.md](Hydrogen.md), [fine_structure_demo.py](fine_structure_demo.py)); the proton/electron ratio `m_p/m_e = 6π⁵` and Koide's `Q = 2/3`; the cosmological term `Ω_Λ = log 2` closing the 10¹²² vacuum catastrophe; **G**, π, e, Euler–Mascheroni γ, Planck length/time, and the age of the universe `t₀ ≈ 13.8 Gyr` ([Experimental_Consistency.md](Experimental_Consistency.md)).
- **The Cosmological Logical Bang** replaces the classical singular Big Bang: the universe originates through constructive possibilist quantum logical synthesis — real logical possibilities (8-twist histories) resolving into ZFA-closed events, bootstrapping spacetime, matter, and the entire observable cosmos from pure logical structure ([Philosophy.md](Philosophy.md)).
