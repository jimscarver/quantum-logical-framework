...
- The complementary Shannon sharpening — that the *continuum* over-parameterizes what any finite channel can identify: [`Shannon_Overfit.md`](Shannon_Overfit.md) (non-identifiability, machine-checked — no real is ever received, every finite record leaves an infinite unconstrained tail).
