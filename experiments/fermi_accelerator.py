...
from qlf.doubler import construct_logical_doubler  # frequency doubling via QuCalc closure extension
# from quantum_simulator import pauli_fold, energy_from_dimension
# from qlf.path_integral import sample_zero_action_histories  # future quantum extension
