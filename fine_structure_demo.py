...
def main():
    ...
    print("  ✓ Three equivalent forms (Bohr, QLF per-qubit, depth-ratio) give the same")
    print("    numerical α.  The depth-ratio form α = sqrt(2 R_e / R_1) expresses α as a")
    print("    ratio of two QLF Markov-blanket depths: electron Compton and hydrogen-")
    print("    ground-state binding.")
    print("  ⚠ Ry and m_e (equivalently R_e and R_1) are calibrated from observation,")
    print("    not derived from QLF first principles.")
