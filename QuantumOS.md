...
- **AI agent members** — optional [agents](https://github.com/jimscarver/quantum-os/tree/main/scripts/qos-cli) (a *facilitator*, *scribe*, *skeptic*, *greeter*) join a room as **full, liquid-trust-governed members** — they only nudge, and the room can `/gov trust` them up or `/gov censure` them down like any peer; they run on a Claude subscription (no API credits). This is QLF's complementary-binding thesis made executable: distinguishable closures (human + AI) binding into a deliberation none is alone. Build your own with the [Developer Guide](https://github.com/jimscarver/quantum-os/blob/main/Developer_Guide.md).
- **Collective optimization** — the room run as a *quantum-annealing-style optimizer*: propose candidates → score them (trust-weighted) → anneal → converge, exactly the substrate's selection-by-closure at the logical layer. `/facil optimize <objective + constraints>` runs a round; a runnable demo (`scripts/qos-cli/optimize-demo.mjs`) shows a room reaching the brute-force optimum of a classic problem. See [`Collective_Optimization.md`](https://github.com/jimscarver/quantum-os/blob/main/Collective_Optimization.md) — including *how it benefits over traditional quantum computation*.

New to it? Start with the **[User Guide](https://github.com/jimscarver/quantum-os/blob/main/User_Guide.md)**, or just **[open a room](https://jimscarver.github.io/quantum-os/)** (and [My room](https://github.com/jimscarver/quantum-os/blob/main/MyRoom.md)).
